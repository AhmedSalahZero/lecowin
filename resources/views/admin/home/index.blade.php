    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
            <a class="dashboard-stat dashboard-stat-v2 red" href="#">
                ...
                <div class="details">
                    <div class="number">
                        <span data-counter="counterup" data-value=" {{\App\Models\Finance::sum('amount')}}">0</span> EGP </div>
                    <div class="desc"> Finances </div>
                </div>
            </a>
        </div>
        <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
