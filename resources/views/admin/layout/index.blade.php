...
<head>
    ...
    <script>
        $('.notification_read').hover(function(){
            ...
            $.ajax({
                type: "POST",
                url:base_url+'/notifications/unread/'+user_id,
                data: {
            ...
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown dropdown-extended dropdown-notification" id="header_notification_bar">
                    <a href="javascript:;" class="dropdown-toggle notification_read" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" base_url="{{ url('/') }}" user_id="{{Auth()->user()->id}}">
                        <i class="icon-bell"></i>
                        <span class="badge badge-default notification_count"> {{count(($currentUser->unReadNotifications))}} </span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="external">
                            <h3>
                                <span class="bold notifications_pending">{{count(($currentUser->unReadNotifications))}} pending</span> notifications</h3>
                                ...
                                @forelse($currentUser->unReadNotifications as $notification)
                                    ...
                                    {{leftTime($notification->created_at)}}
                                            ...
                                            <span class="details">
                                                    ...
                                                    </span> {{$notification->data['message_en']}}</span>
                                        </a>
                                    </li>
                                @empty
                                    <li>
...
{{--                        </li>--}}
                ...
                <li class="dropdown dropdown-quick-sidebar-toggler">
                    <a href="{{Route('admin.logout',App()->getLocale())}}" class="dropdown-toggle">
...
{{--                </li>--}}
                    ...
                    <ul class="sub-menu">
                        <li class="nav-item  ">
                            <a href="{{Route('libraries.index')}}" class="nav-link ">
                                <span class="title">Libraries</span>
                                <span class="badge badge-success">{{count(\App\Models\Library::all())}}</span>
                            </a>
                        </li>
                ...
                <li class="nav-item  ">
                    <a href="{{Route('admin.send.notification')}}" class="nav-link ">
                        <i class="icon-bell"></i>
