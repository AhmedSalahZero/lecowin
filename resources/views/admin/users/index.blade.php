    ...
    <div class="portlet">
        ...
        <table id="myTable" class="display">
            ...
            <tr>
                ...
                <th>  <i class="fa fa-share-alt"></i> Network</th>
                <th>  <i class="fa fa-money"></i> Transfer</th>
                <th>  <i class="fa fa-money"></i> Transactions</th>
            ...
            @if(count($users) > 0)
                @foreach($users as $user)
                    ...
                    <tr>
                        ...
                        <td > {{$user->phone}}</td>
                        <td > {{$user->address}}</td>
                        <td > {{$user->getMaxLevel()}}</td>
                        <td > {{$user->generateCode()}}</td>
                        <td > {!! optional($user->parent)->first_name .' ' . optional($user->parent)->last_name!!} </td>
                        <td>
                            <button type="button" class="btn btn-outline btn-circle dark btn-sm black "  data-toggle="modal" data-target="#exampleModalLong_network{{$user->id}}">
                                <i class="fa fa-share-alt" id=""></i>
                            </button>

                            <div class="modal fade " id="exampleModalLong_network{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h5 style="padding: 0;margin: 0" class="modal-title" id="exampleModalLongTitle">
                                                Network profits for : {{$user->first_name . ' ' . $user->last_name }}
                                            </h5>
                                        </div>
                                        <div class="modal-body">
                                            <h3 class="hidden-xs"> All NetWorkers       : {!! $user->countTotalNetworks()!!} </h3>
                                            <h3 class="hidden-xs"> Basic Profit         : {!! $user->CountLevelsProfit() !!} EGP </h3>
                                            <h3 class="hidden-xs"> Forth Profit         :{!! $user->CountLevelsForthCost() !!} EGP</h3>
                                            <h3 class="hidden-xs"> Total Network profit :{!! $user->totalNetworkProfit() !!} EGP </h3>
                                        </div>
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h5 style="padding: 0;margin: 0" class="modal-title" id="exampleModalLongTitle">
                                                transfer money To : {{$user->first_name . ' ' . $user->last_name}}
                                            </h5>
                                        </div>
                                        <div class="modal-body">
                                                                ...
                                                                <div class="form-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="input-icon">
                                                                            <input style="font-size: 17px;" type="text" class="form-control"   name="amount" value="{{old('amount')}}" > </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                        ...
                        <td>
                            <a href="{{Route('transactions.show',$user->id)}}" type="button" class="btn btn-outline btn-circle dark btn-sm black " >
                                <i class="fa fa-money" id=""></i>
                            </a>
                                                ...
                                                <form enctype="multipart/form-data" action="{{route('admin.active',$user->id)}}" method="post">
                                                    ...
                                                    <div class="row">
                                                        <h4 style="padding-left:20px ">
                                                            Active {{$user->first_name . ' ' . $user->last_name}} Account ?
...
{{--                               <td class="hidden-xs"> {{$user->generateCode()}}</td>--}}
{{--                               <td class="hidden-xs"> {!! optional($user->parent)->first_name .' ' . optional($user->parent)->last_name!!} </td>--}}
{{--                               <td>--}}
{{--                                   <button type="button" class="btn btn-outline btn-circle dark btn-sm black "  data-toggle="modal" data-target="#exampleModalLong_network{{$user->id}}">--}}
{{--                                       <i class="fa fa-share-alt" id=""></i>--}}
{{--                                   </button>--}}
