...
{{--                        </li>--}}
                        <li>
                            <a href="{{Route('wallet.index')}}">
                                <i class="icon-envelope-open"></i> My wallet
        ...
        <div class="page-sidebar navbar-collapse collapse">
            ...
            <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
                ...
                <li class="nav-item  networker_nav">
                    <a href="{{Route('user.networkers.show')}}" class="nav-link ">
                        <i class="icon-diamond"></i>
                        <span class="title">netWorkers</span>

                    </a>

                </li>
                <li class="nav-item  library_nav">
                    <a href="{{Route('main.libraries.show')}}" class="nav-link ">
                        <i class="icon-diamond"></i>
...
<script>
    ...
    window.__lc.license ={{\App\Models\Setting::where('setting_name','liveChatCode')->first()->setting_value}};
    ;(function(n,t,c){function i(n){return e._h?e._h.apply(null,n):e._q.push(n)}var e={_q:[],_h:null,_v:"2.0",on:function(){i(["on",c.call(arguments)])},once:function(){i(["once",c.call(arguments)])},off:function(){i(["off",c.call(arguments)])},get:function(){if(!e._h)throw new Error("[LiveChatWidget] You can't use getters before load.");return i(["get",c.call(arguments)])},call:function(){i(["call",c.call(arguments)])},init:function(){var n=t.createElement("script");n.async=!0,n.type="text/javascript",n.src="https://cdn.livechatinc.com/tracking.js",t.head.appendChild(n)}};!n.__lc.asyncInit&&e.init(),n.LiveChatWidget=n.LiveChatWidget||e}(window,document,[].slice))
</script>
<noscript><a href="https://www.livechatinc.com/chat-with/{{\App\Models\Setting::where('setting_name','liveChatCode')->first()->setting_value}}/" rel="nofollow">Chat with us</a>, powered by <a href="https://www.livechatinc.com/?welcome" rel="noopener nofollow" target="_blank">LiveChat</a></noscript>
