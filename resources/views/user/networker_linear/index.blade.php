...
@section('header_link')
    ...
    <li>
        <span>@lang('lang.Linear Network')</span>
    </li>
@endsection
                    ...
                    <div class="row widget-row">
                                ...
                                <div class="portlet light portlet-fit bordered">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            ...
                                            <span class="caption-subject bold font-dark uppercase "> @lang('lang.networkers')</span>
                        ...
                        @foreach($levelNetWork['networkers'] as $netWork)
                                ...
                                <li>
                                    ...
                                    <a href="#{{$i}}" data-date="{{date($netWork->netWorker->created_at)}}" class="border-after-red bg-after-red selected" style="left: {{$left}}px;">
                                        <img src="{{asset('storage/'.$netWork->netWorker->image)}}" width="50px" height="50px" style="object-fit: fill">
                                    </a>
                                </li>
                                                                <?php $left = $left+180 ?>
{{--                            <div class="col-xs-2 networkItem">--}}
{{--                                <!-- BEGIN WIDGET THUMB -->--}}
{{--                                <div class=" widget-bg-color-white text-uppercase margin-bottom-20 bordered" >--}}
{{--                                    <div class="itemNumber">{{ $i }}</div>--}}
                                    <?php ++$i ; ?>
{{--                                    <div class="networkerPhoto" style="background-image: url({{asset('storage/'.$netWork->netWorker->image)}});"></div>--}}
...
{{--                            </div>--}}
                        ...
                        @endforeach
                                                        ...
                                                        <span class="filling-line bg-red" aria-hidden="true" style="transform: scaleX(0.0769236);"></span>
                                                    </div>
                                                    <!-- .events -->
                                                </div>
                                                <!-- .events-wrapper -->
...
<![endif]-->
  ...
  <script>
          ...
          $('.networker_linear_nav').addClass('active');
