...
@section('header_link')
    ...
    <li>
        <span>@lang('lang.my children')</span>
    </li>
@endsection
                            ...
                            @foreach($myChildren as $child)
                                ...
                                <div class="col-md-6 blockItem"  >
                                    <div class=" widget-bg-color-white text-uppercase margin-bottom-20 bordered" >
                                            ...
                                            <a class="css_children_anchor" href="{{route('user.networkers.show.my.children',[App()->getLocale() , $child->id])}}">
                                                <div class="col-md-6 networkItem"  >
                                                    <div class="itemNumber">{{ $a }}</div>
                                                    <?php $a++; ?>
                                                    <div class="networkerPhoto" style='background-image: url("{{asset('storage/'.$child->image)}}");'></div>
