        ...
        <div class="row widget-row">
            ...
            @if(Auth()->user()->isActivated() && Auth()->user()->notAdmin())
                <div class="col-md-3">
                    <!-- BEGIN WIDGET THUMB -->
                    <div class="widget-thumb widget-bg-color-white text-uppercase margin-bottom-20 bordered">
                        <h4 class="widget-thumb-heading">@lang('Account expires at')</h4>
                        <div class="widget-thumb-wrap">
                            <i class="widget-thumb-icon bg-blue icon-calendar"></i>
                            <div class="widget-thumb-body">
                                <span class="widget-thumb-subtitle">@lang('year')</span>
                ...
                <div class="portlet light ">
                    <div class="portlet-title tabbable-line">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-dark bold uppercase">Time Lines</span>
                        </div>
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="tab_1_1">
                                <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 339px;"><div class="scroller" style="height: 339px; overflow: hidden; width: auto;" data-always-visible="1" data-rail-visible="0" data-initialized="1">
                                        <ul class="feeds time_lines_notifications">
                                            ...
                                            @foreach(Auth()->user()->notifications as $notification)
                                                <li>
                                                    ...
                                                    <div class="col2">
                                                        <div class=""> {{(leftTime($notification->created_at))}}</div>
                                                    </div>
                                                </li>
                                    ...
                                    </div><div class="slimScrollBar" style="background: rgb(187, 187, 187); width: 7px; position: absolute; top: 0px; opacity: 0.4; display: block; border-radius: 7px; z-index: 99; right: 1px; height: 183.58px;"></div>
        ...
        var Dashboard = function() {
            ...
            return {
                ...
                initCharts: function() {
                    ...
                    var visitors = [
                            @foreach(\App\Models\Level_finance::countUserNetWorkers(Auth()->user()) as $key=>$counter)
                        ['{{$key}}', {{$counter}}],
                        @endforeach
                    ];
