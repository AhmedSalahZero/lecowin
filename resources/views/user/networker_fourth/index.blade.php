...
@section('header_link')
    ...
    <li>
        <span>@lang('lang.Forth Network')</span>
    </li>
@endsection
            ...
            <div class="portlet-body">
                <div class="row number-stats ">
                    <div class="row widget-row">
                        ...
                        @foreach(array_chunk($levelNetWork['networkers']->toArray(),4) as $foruth)
                                    <div class="col-md-5 blockItem"  >
                                        <div class=" widget-bg-color-white text-uppercase margin-bottom-20 bordered" >
                                            <?php $a=0; ?>
                            @foreach($foruth as $one)
                                                <?php $a++; ?>
                                                <div class="col-md-6 networkItem"  >
                                                    <div class="itemNumber">{{ $a }}</div>
                                                    <div class="networkerPhoto" style='background-image: url("{{asset('storage/'.$one['net_worker']['image'])}}");'></div>
                                                    <div class="widget-thumb-body">

                                        <span class="widget-thumb-body-stat "  >
                               {{$one['net_worker']['first_name'] .' '.$one['net_worker']['last_name'] }}
                                        </span>
                                                    </div>
                                                </div>
                                                @if($a==4)
